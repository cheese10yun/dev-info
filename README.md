# Dev-Info
[![Hits](https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Fgithub.com%2Fcheese10yun%2Fdev-info&count_bg=%2379C83D&title_bg=%23555555&icon=&icon_color=%23E7E7E7&title=hits&edge_flat=false)](https://hits.seeyoufarm.com)
...
* [목차](#목차)
* [추천 온라인 강의](#추천-온라인-강의)
  * [객체 지향 프로그래밍 입문](#객체-지향-프로그래밍-입문)
  * [IntelliJ를 시작하시는 분들을 위한 IntelliJ 가이드](#intellij를-시작하시는-분들을-위한-intellij-가이드)
  * [테스트주도개발(TDD)로 만드는 NodeJS API 서버](#테스트주도개발tdd로-만드는-nodejs-api-서버)
  * [스프링 프레임워크 입문 (기존 수강자만 수강 가능)](#스프링-프레임워크-입문-기존-수강자만-수강-가능)
  * [Clean Code, SOLID 강의](#clean-code-solid-강의)
  * [Spring 다양한 방송](#spring-다양한-방송)
  * [HTTPS와 SSL 인증서](#https와-ssl-인증서)
  * [백기선의 스프링 부트 개념과 활용](#백기선의-스프링-부트-개념과-활용)
  * [백기선의 스프링 데이터 JPA](#백기선의-스프링-데이터-jpa)
  * [백기선의 스프링 프레임워크 핵심 기술](#백기선의-스프링-프레임워크-핵심-기술)
  * [백기선의 스프링 기반 REST API 개발](#백기선의-스프링-기반-rest-api-개발)
  * [백기선의 스프링 웹 MVC](#백기선의-스프링-웹-mvc)
  * [~~컴퓨터 공학 올인올 패키지~~ (강의 없어짐)](#컴퓨터-공학-올인올-패키지-강의-없어짐)
  ...
  * [[토크ON세미나] 쿠버네티스 살펴보기](#토크on세미나-쿠버네티스-살펴보기)
  * [스프링캠프 2018](#스프링캠프-2018)
  * [클린 코드](#클린-코드)
  * [OKKYCON: 2018  The Real TDD - TDD 제대로 알기](#okkycon-2018--the-real-tdd---tdd-제대로-알기)
  * [리눅스 커맨드라인 툴](#리눅스-커맨드라인-툴-)
  * [IT 보안을 위한 ELK 통합로그시스템 구축과 활용](#it-보안을-위한-elk-통합로그시스템-구축과-활용)
  * [[우아한테크세미나] : 우아한 객체지향](#우아한테크세미나--우아한-객체지향)
  * [[우아한테크세미나] : 우아한멀티모듈](#우아한테크세미나--우아한멀티모듈)
  * [실전! Querydsl](#실전-querydsl)
* [추천 도서](#추천-도서)
  ...
  * [DDD Start](#ddd-start)
  * [이것이 자바다](#이것이-자바다)
  * [처음 배우는 스프링 부트 2](#처음-배우는-스프링-부트-2-)
  * [OAuth 2.0 쿡북](#oauth-20-쿡북-)
  * [Java8 in Action](#java8-in-action)
  * [스프링 5.0 마스터](#스프링-50-마스터)
  * [피플웨어](#피플웨어)
  * [함께자라기 - 애자일](#함께자라기---애자일)
  * [MySQL 5.7 완벽 분석](#mysql-57-완벽-분석)
  * [오브젝트](#오브젝트)
  * [Kotlin in Action](#kotlin-in-action)
  * [운영 체제와 정보 기술의 원리](#운영-체제와-정보-기술의-원리)
  * [클린 코더](#클린-코더)
  * [스프링 마이크로서비스 코딩 공작소](#스프링-마이크로서비스-코딩-공작소)
  * [스프링 부트와 AWS로 혼자 구현하는 웹서비스](#스프링-부트와-aws로-혼자-구현하는-웹서비스)
  * [도메인 주도 설계란 무엇인가?](#도메인-주도-설계란-무엇인가)
  * [코틀린 리액티브 프로그래밍](#코틀린-리액티브-프로그래밍)
  * [Real MySQL](#real-mysql)
  * [아파치 카프카 애플리케이션 프로그래밍](#아파치-카프카-애플리케이션-프로그래밍)
  * [실전 아파치 카프카](#실전-아파치-카프카)
  * [다재다능 코틀린 프로그래밍](#다재다능-코틀린-프로그래밍)
  * [나만의 데이터 분석 플랫폼 엘라스틱서치](#나만의-데이터-분석-플랫폼-엘라스틱서치)
  * [이펙티브 코틀린](#이펙티브-코틀린)
<!-- TOC -->
...
## 객체 지향 프로그래밍 입문
* [[인프런] [유료] 강의](https://www.inflearn.com/course/%EA%B0%9D%EC%B2%B4-%EC%A7%80%ED%96%A5-%ED%94%84%EB%A1%9C%EA%B7%B8%EB%9E%98%EB%B0%8D-%EC%9E%85%EB%AC%B8/)
...
* [[인프런] [유료] 강의](https://www.inflearn.com/course/intellij-guide/)
* 이클립스에서 IntelliJ를 변경하고 싶은 사람에게 추천

## 테스트주도개발(TDD)로 만드는 NodeJS API 서버
* [[인프런] [유료] 강의](https://www.inflearn.com/course/%ED%85%8C%EC%8A%A4%ED%8A%B8%EC%A3%BC%EB%8F%84%EA%B0%9C%EB%B0%9C-tdd-nodejs-api/)
...
* 강의 자료도 [GitHub](https://github.com/msbaek/clean-coders-2013)에 공개 되어 있음
...
* [[인프런] [유료] 강의](https://www.inflearn.com/course/spring-framework_core/)
* 스프링 입문자에게 추천
...
* [[Youtube] [무료] 강의](https://www.youtube.com/watch?v=WfrSN9Z7MiA&list=PL9mhQYIlKEhfpMVndI23RwWTL9-VL-B7U)
...
## 실전! Querydsl
* [[인프런] [유료] 강의](https://www.inflearn.com/course/Querydsl-%EC%8B%A4%EC%A0%84#)
...
## 도메인 주도 설계란 무엇인가?
* [도서](http://www.yes24.com/Product/Goods/5445597)
...
* [도서](http://www.yes24.com/Product/Goods/99122569)
* 카프카 입문자에게 추천, 카프카에 대한 지식을 빠르게 학습 가능

## 실전 아파치 카프카
* [도서](http://www.yes24.com/Product/Goods/97652533?OzSrank=2)
* 카프카의 오프셋, 메세지 전송시  파티셔닝, 컨슈머 롤백, 프로듀서의 메시지 도달 보증 수준 등등 카프카에 대한 이해를 알기 쉬윈 도표로 잘설명

## 다재다능 코틀린 프로그래밍
* [도서](http://www.yes24.com/Product/Goods/102420022?OzSrank=1)
* 코틀린 입문자보다 코틀린을 1년 이상 사용해본 분들에게 추천, 코틀린을 보다 코틀린 스럽게 사용하고 싶은 분들 필독서

## 나만의 데이터 분석 플랫폼 엘라스틱서치
* [도서](http://www.yes24.com/Product/Goods/98828441?OzSrank=1)
* 키바나 사각화 툴에 대한 사용법, 엘라스틱서에 대한 내용 보다는 키바나 사용법이 주로 정리

## 이펙티브 코틀린
* [도서](http://www.yes24.com/Product/Goods/107464876)
* 이펙트브 자바와 비슷한 내용이 있으나 코틀린에 대한 부분도 상당히 있어 코틀린 입문 도서로 기본적인 코틀린 학습 이후 읽는 것을 권장 

## 코틀린 동시성 프로그래밍
* [도서](https://www.yes24.com/Product/Goods/90338766)
* 코루틴에 대해서 깊게 다루는 거의 유일한 도서로 코루틴을 입문하는 분들에게 권장
* 예제들이 안드로이드로 되어 있지만 코루틴 개념에 대해서는 디테일한 개념을 설명하기 때문에 안드로이드를 몰라서 큰 지장은 없음